								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<div class="d-flex flex-column">
										...
										<div class="d-flex align-items-center font-weight-bold my-2">
											...
											<a href="" class="text-dark text-hover-white opacity-75 hover-opacity-100">Permintaan</a>
                                            <!--end::Item-->
                                            <!--begin::Item-->
											<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                                            ...
                                            <div class="card-body">
                                                <div class="col-12">
                                                    <ul class="navi navi-hover navi-active navi-accent">
                                                        <li class="navi-item">
                                                            <a class="navi-link <?php echo $request_active; ?>" href="<?php echo base_url(); ?>pengajuan/kehadiran/req">
                                                                <span class="navi-icon"><i class="flaticon2-analytics"></i></span>
                                                                <span class="navi-text">Pengajuan Kehadiran</span>
                                                                <!-- <span class="label label-light-danger font-weight-bold label-inline">new</span> -->
                                                            </a>
                                                        </li>
                                                        <li class="navi-item">
                                                            <a class="navi-link <?php echo $history_active; ?>" href="<?php echo base_url(); ?>pengajuan/kehadiran/history">
        ...
        <script>
            ...
            $('#btn-approve').click(function (e) {
                ...
                if ($('#comment_approve').val() != '') {
                    ...
                    $.ajax({
                        url : "<?php echo base_url('pengajuan/kehadiran_disetujui'); ?>",
                        type: "POST",
                        data: postData,
                        processData: false,
                        contentType: false,
            ...
            $('#btn-reject').click(function (e) {
                ...
                if ($('#comment_reject').val() != '') {
                    var postData = new FormData(this.form);                        
                    $.ajax({
                        url : "<?php echo base_url('pengajuan/kehadiran_ditolak'); ?>",
                        type: "POST",
                        data: postData,
                        processData: false,
                        contentType: false,
			...
			function getData() {
                return new Promise((resolve) => {
                    $.ajax({    
                        type: "GET",
                        url: "<?php echo base_url('pengajuan/ambil_data_kehadiran/'); ?><?php echo $status; ?>",             
                        dataType: "JSON",   
