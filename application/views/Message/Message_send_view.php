					...
					<form method="POST" action="" id="form-add">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="exampleSelect1">Time Off Type</label>
                                <select class="form-control" name="time_off_type" id="time_off_type">
							...
							<div class="form-group">
								...
								<div class="input-group date">
									<input type="text" class="form-control form-control-sm" readonly="readonly" value="" name="start_date" id="start_date" />
							...
							<div class="form-group">
								...
								<div class="input-group date">
									<input type="text" class="form-control form-control-sm" readonly="readonly" value="" name="end_date" id="end_date" />
									<div class="input-group-append">
										<span class="input-group-text">
											<i class="la la-calendar"></i>
										</span>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light-primary font-weight-bold" id="btn-cancel" data-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary font-weight-bold" id="btn-save">Save changes</button>
                        </div>
                    </form>
				</div>
			</div>
        ...
        <script>
			function getData() {
                return new Promise((resolve) => {
                    $.ajax({    
                        type: "GET",
                        url: "<?php echo base_url('message/message_get_data'); ?>",             
                        dataType: "JSON",   
